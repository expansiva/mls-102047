...
export const mensalidadesAcademiaRules = {
  ...
  "rules": {
    ...
    "alunoBloqueadoPorDuasMensalidadesVencidas": "O aluno com três ou mais mensalidades vencidas fica bloqueado e não pode entrar na academia até deixar de possuir três mensalidades vencidas.",
