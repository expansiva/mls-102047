/// <mls fileReference="_102047_/l2/controleChamados/web/desktop/page11/commentOpenTicket.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "commentOpenTicket",
  "variant": "page11",
  "actor": "atendente",
  "cases": [
    {
      "id": "qryLocateTicket.ok",
      "routine": "controleChamados.commentOpenTicket.qryLocateTicket",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    {
      "id": "cmdRecordComment.ok",
      "routine": "controleChamados.commentOpenTicket.cmdRecordComment",
      "params": {
        "ticketId": "<seedRef>",
    ...
    {
      "id": "cmdRecordComment.commentText.required",
      "routine": "controleChamados.commentOpenTicket.cmdRecordComment",
      "params": {
        "ticketId": "<seedRef>"
      },
