export const descriptions = [
  {
    ...
    "kind": "summary",
    "description": "Prioriza los conteos de órdenes abiertas, en análisis y listas para entregar para una lectura rápida en pantalla reducida, usando los resultados de la consulta. Mientras se consulta, comunica que los indicadores se están actualizando; si no hay resultados, indica que no hay órdenes para resumir; y si falla, presenta el error de consulta de forma comprensible. Los valores y su estado deben poder leerse mediante texto accesible, no solo por señales visuales.",
    "contentRef": "base",
    "capabilityRefs": [
      "listOrdenServicio",
  ...
  },
  {
    ...
    "kind": "highlights",
    "description": "Da prioridad de lectura a las órdenes y aparatos que la recepcionista debe revisar primero, incluidos los disponibles para retiro cuando estén presentes en los resultados. Durante la carga informa que los destacados se están obteniendo; sin resultados explica que no hay elementos destacados; y ante un error ofrece un mensaje accesible sobre la consulta no disponible. Cada elemento debe tener una identificación textual clara y ser operable mediante toque y tecnologías de asistencia.",
    "contentRef": "base",
    "capabilityRefs": [
      "listOrdenServicio",
      "ui.inicio_recepcionista.listOrdenServicio.status",
  ...
  },
  {
    ...
    "kind": "inbox",
    "description": "Muestra de forma escaneable las órdenes que esperan atención de recepción para identificar las relacionadas con recibir un aparato o entregar uno listo. Esta página solo dispone de consulta de órdenes: no ejecuta aquí la recepción ni la entrega. Conserva la posibilidad de cambiar la página de resultados y volver a consultar mediante interacción táctil con nombre accesible; informa carga, ausencia de órdenes y errores.",
    "contentRef": "base",
    "capabilityRefs": [
      "listOrdenServicio",
    ...
    "moleculeRecommendations": [
      {
        ...
        "reason": "La consulta devuelve una colección de órdenes que debe revisarse y paginarse en pantallas estrechas."
      },
      {
        "groupId": "groupShowProgress",
        "candidates": [
...
export const pipeline = [
  {
    "id": "inicio_recepcionista__mobile__page11",
    "type": "l2_page",
    "defPath": "l2/ordenServicio/web/mobile/page11/inicio_recepcionista.defs.ts",
    "outputPath": "l2/ordenServicio/web/mobile/page11/inicio_recepcionista.ts",
    "dependsFiles": [
