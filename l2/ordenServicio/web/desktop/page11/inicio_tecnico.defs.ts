    ...
    "moleculeRecommendations": [
      {
        ...
        "reason": "La consulta respalda indicadores destacados de los estados de trabajo descritos."
      }
    ]
  },
  {
    ...
    "kind": "highlights",
    "description": "Presenta órdenes urgentes del taller y aparatos disponibles para retiro dentro de los resultados de órdenes de servicio. Permite revisar los elementos recuperados por la consulta; durante la carga debe anunciarse la espera, sin resultados debe indicarse que no hay elementos destacados y ante un error debe mostrarse un mensaje accesible.",
    "contentRef": "base",
    "capabilityRefs": [
      "listOrdenServicio"
    ],
    "moleculeRecommendations": [
      {
        ...
        "reason": "La consulta devuelve una colección de órdenes que puede revisarse como registros destacados."
      }
    ]
  },
  {
    ...
    "kind": "alerts",
    "description": "Muestra avisos relacionados con los plazos de diagnóstico y reparación que el técnico debe cumplir, usando las órdenes consultadas. Debe diferenciar los estados de carga, ausencia de avisos y error, con mensajes perceptibles y legibles mediante lector de pantalla.",
    "contentRef": "base",
    "capabilityRefs": [
      "listOrdenServicio"
    ],
    ...
    "moleculeRecommendations": [
      {
        ...
        "reason": "La consulta proporciona una colección de órdenes pendiente de revisión."
      },
      {
        "groupId": "groupNotifyUser",
        "candidates": [
...
export const pipeline = [
  {
    "id": "inicio_tecnico__desktop__page11",
    "type": "l2_page",
    "defPath": "l2/ordenServicio/web/desktop/page11/inicio_tecnico.defs.ts",
    "outputPath": "l2/ordenServicio/web/desktop/page11/inicio_tecnico.ts",
    "dependsFiles": [
